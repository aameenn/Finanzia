...
Das Favicon (goldener Doktorhut auf dunklem Grund, identisch zum Logo im Header) ist bereits fertig eingebunden — die Dateien `favicon.ico`, `favicon-16x16.png`, `favicon-32x32.png`, `apple-touch-icon.png`, `android-chrome-192x192.png` und `android-chrome-512x512.png` liegen im selben Ordner wie `index.html` und sind dort bereits im `<head>` verlinkt. Beim Hochladen einfach alle Dateien zusammen ins Repository legen — nichts weiter einzurichten.

## Struktur

- `index.html` — die komplette Seite (HTML, CSS, JavaScript für den Sprachumschalter AR/DE, alle Bilder als Base64 eingebettet, Favicon-Verlinkung im `<head>`)
- `favicon.ico`, `favicon-16x16.png`, `favicon-32x32.png`, `apple-touch-icon.png`, `android-chrome-192x192.png`, `android-chrome-512x512.png` — die Favicon-Dateien
